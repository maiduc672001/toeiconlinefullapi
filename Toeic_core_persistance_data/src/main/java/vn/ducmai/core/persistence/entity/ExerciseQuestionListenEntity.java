...
@Entity
@Table(name = "exercisequestionlisten")
public class ExerciseQuestionListenEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer exerciseQuestionListenId;

    public Integer getExerciseQuestionListenId() {
        return exerciseQuestionListenId;
    }

    public void setExerciseQuestionListenId(Integer exerciseQuestionListenId) {
        this.exerciseQuestionListenId = exerciseQuestionListenId;
    }
